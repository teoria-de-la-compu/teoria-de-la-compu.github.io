...
En general una fuente de n-símbolos alcanza la mayor entropía posible cuando son equiproblables.
...
**Entrada**. Un conjunto de símbolos $$ \{ s_1, s_2, .., s_n \} $$ cada uno con un peso $$ p_1, p_2, .., p_n $$. El peso puede ser probabilidad, costo de transferencia, tamaño en bits, etc.
...
- Empezamos con el conjunto con el conjunto:
...
- Cuando el proceso termina nos queda un árbol binario único que en las ojas tiene símbolos $$ s_i $$.
...
![Ejemplo de Codificación de Huffman](huffman1.png){:class="img-responsive"}
